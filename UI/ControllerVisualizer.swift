...
//  XboxControllerApp
//
//  Visualização em tempo real do estado do controle e Componentes UI
//
...
struct BatteryView: View {
    ...
    var body: some View {
        ...
        .help("Nível da Bateria: \(level)%")
    }
}

// ... Resto dos componentes (DPadView, AnalogStickView, etc.) mantidos iguais ...
